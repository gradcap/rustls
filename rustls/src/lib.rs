    ...
    pub mod msgs {
        ...
        pub mod handshake {
            pub use crate::msgs::handshake::{
                CertificateChain, ClientExtension, ClientHelloPayload, ClientSessionTicket,
                DistinguishedName, EchConfigContents, EchConfigPayload,
                HandshakeMessagePayload, HandshakePayload, HpkeKeyConfig, HpkeSymmetricCipherSuite,
                KeyShareEntry, Random, ServerExtension, ServerHelloPayload, ServerName, SessionId,
            };
        }
        pub mod message {
